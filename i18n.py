...
STRINGS = {
    ...
    "menu_cost_log": {"en": "Cost change log", "ar": "سجل تغيّر التكلفة"},
    "cost_title": {"en": "Cost change log", "ar": "سجل تغيّر التكلفة"},
    "cost_empty": {"en": "No cost changes recorded yet.", "ar": "لا توجد تغييرات في التكلفة حتى الآن."},
    "menu_restore_backup": {"en": "Restore a backup\u2026", "ar": "استرجاع نسخة احتياطية…"},
    "restore_title": {"en": "Restore a backup", "ar": "استرجاع نسخة احتياطية"},
    "restore_confirm": {"en": "The backup will be restored into a new folder. Your current data is not touched.", "ar": "سيتم استرجاع النسخة في مجلد جديد. بياناتك الحالية لن تتأثر."},
    "restore_switch": {"en": "Switch to the restored data now?", "ar": "التبديل إلى البيانات المسترجَعة الآن؟"},
    "restore_done": {"en": "Restore finished.", "ar": "تم الاسترجاع."},
    "restore_failed": {"en": "Restore failed", "ar": "فشل الاسترجاع"},
